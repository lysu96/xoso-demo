  ...
  return (
    <div className="max-w-4xl mx-auto p-4 font-sans bg-gray-50 min-h-screen">
      ...
      <div className="bg-red-100 p-4 flex flex-wrap gap-2 justify-center border-b border-red-200">
        {["2KG", "3KG", "9KG", "10KG", "13KG", "14KG", "15KG", "18KG"].map(
          (code) => (
            <span
              key={code}
        ...
        <table className="w-full">
          ...
          <tbody>
            ...
            <tr className="border-b border-gray-200">
              ...
              <td className="p-3">
                <div className="flex justify-center">
                  <span className="text-3xl font-bold text-red-600">85676</span>
                </div>
              </td>
            </tr>
            ...
            <tr className="border-b border-gray-200">
              ...
              <td className="p-3">
                <div className="flex justify-center">
                  <span className="text-2xl font-bold text-black">80867</span>
                </div>
              </td>
            </tr>
            ...
            <tr className="border-b border-gray-200">
              ...
              <td className="p-3">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 justify-items-center">
                  {["07335", "37081", "43233", "76886", "85847", "33147"].map(
                    (num) => (
            ...
            <tr className="border-b border-gray-200">
              ...
              <td className="p-3">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 justify-items-center">
                  {["3273", "9285", "9205", "9145", "4512", "9153"].map(
                    (num) => (
                      <span key={num} className="text-xl font-bold text-black">
                        {num}
                      </span>
          ...
          <tbody>
            {[
              ...
              [
                "6",
                "7,6,6,0,8",
                <span className="text-red-600 font-bold">7,6,8,6</span>,
                "6",
              ],
              [
                "7",
                <span className="text-red-600 font-bold">6,4,5,3</span>,
                "6,4,4",
                "7",
              ],
              ["8", "1,6,5,5", "6", "8"],
      ...
      <div className="mt-8 bg-red-50 border-l-4 border-red-500 p-4 rounded-r shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
          <p className="flex items-start">
            ...
            <span>
              <span className="font-bold">66</span>: Về liên tiếp 3 ngày
            </span>
          </p>
          <p className="flex items-start">
            <span className="text-red-600 font-bold mr-2">•</span>
            <span>
              <span className="font-bold">33</span>: Về liên tiếp 2 ngày
            </span>
          </p>
          <p className="flex items-start">
            <span className="text-red-600 font-bold mr-2">•</span>
            <span>
              <span className="font-bold">86</span>: Về liên tiếp 2 ngày
            </span>
          </p>
          <p className="flex items-start">
            <span className="text-red-600 font-bold mr-2">•</span>
            <span>
              <span className="font-bold">47</span>: Về 2 lần
            </span>
          </p>
          <p className="flex items-start">
            <span className="text-red-600 font-bold mr-2">•</span>
            <span>
              <span className="font-bold">93</span>: Gan 9 ngày đã về
            </span>
          </p>
          <p className="flex items-start">
            <span className="text-red-600 font-bold mr-2">•</span>
            <span>
              <span className="font-bold">85</span>: Về liên tiếp 2 ngày
            </span>
          </p>
          <p className="flex items-start">
            <span className="text-red-600 font-bold mr-2">•</span>
            <span>
              <span className="font-bold">73</span>: Gan 16 ngày đã về
            </span>
          </p>
          <p className="flex items-start">
            <span className="text-red-600 font-bold mr-2">•</span>
            <span>
              <span className="font-bold">15</span>: Gan 10 ngày đã về
            </span>
          </p>
        </div>
      </div>
