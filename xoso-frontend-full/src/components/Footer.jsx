        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-red-100 mb-4">
              Cung cấp thông tin kết quả xổ số nhanh chóng, chính xác và đầy đủ
              nhất. Đồng hành cùng bạn trên hành trình may mắn!
            </p>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 pb-2 border-b border-red-600">
              Liên kết nhanh
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-red-100">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 mr-2 mt-0.5 text-yellow-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <li className="flex items-start">
                ...
                <span>
                  Địa chỉ: Tầng 10, Tòa nhà Alpha, 123 Trần Hưng Đạo, Hà Nội
                </span>
              </li>
            </ul>
            ...
            <div className="mt-6 p-3 bg-red-900 rounded-lg text-xs text-red-200">
              ...
              <p>
                Trang web này chứa quảng cáo từ Google Ads. Chúng tôi sử dụng
                cookie để cá nhân hóa quảng cáo và phân tích lưu lượng truy cập.
              </p>
            </div>
          </div>
        </div>
