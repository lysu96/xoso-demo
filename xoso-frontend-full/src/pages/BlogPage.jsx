  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Khám phá những phương pháp soi cầu hiệu quả được các chuyên gia xổ số chia sẻ để tăng tỷ lệ trúng thưởng. Bài viết cung cấp cái nhìn toàn diện từ cơ bản đến nâng cao.",
      date: "27/09/2024",
      readTime: "8 phút",
      category: "experience",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Hướng dẫn chi tiết cách sử dụng bạc nhớ để dự đoán các con số có khả năng về cao trong ngày. Phương pháp này đã được kiểm chứng qua nhiều năm.",
      date: "26/09/2024",
      readTime: "6 phút",
      category: "analysis",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Tổng hợp danh sách các con lô gan dài nhất tại miền Bắc và chiến thuật đánh lô gan hiệu quả. Dữ liệu được cập nhật hàng tuần.",
      date: "25/09/2024",
      readTime: "5 phút",
      category: "statistics",
      image:
        "https://images.unsplash.com/photo-1463171379579-3fdfb86d6285?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      featured: true,
    },
    {
      id: 4,
      ...
      excerpt:
        "Phương pháp đánh lô xiên mang lại tỷ lệ trúng cao với vốn đầu tư hợp lý. Bài viết chia sẻ kinh nghiệm từ các cao thủ lâu năm.",
      date: "24/09/2024",
      readTime: "7 phút",
      category: "experience",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Phân tích và dự đoán các cầu lô đẹp có khả năng về cao trong tuần tại miền Bắc. Cập nhật dữ liệu mới nhất từ hệ thống thống kê.",
      date: "23/09/2024",
      readTime: "4 phút",
      category: "prediction",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Khám phá ý nghĩa và nguồn gốc của các con số may mắn trong văn hóa xổ số. Tại sao một số con số lại được ưa chuộng hơn những số khác?",
      date: "22/09/2024",
      readTime: "9 phút",
      category: "analysis",
      image:
            ...
            {featuredPosts.map((post) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-red-800 mb-4 line-clamp-3">
                    {post.excerpt}
                  </p>
